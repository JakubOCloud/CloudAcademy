...
docker run --rm -p 5433:5432 --name payments-db -e POSTGRES_DB=payments -e POSTGRES_USER=payments -e POSTGRES_PASSWORD=payments -e POSTGRES_HOST_AUTH_METHOD=trust postgres:16
